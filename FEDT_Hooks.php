...
//				);
        ...
        public function fedt_remove_admin_bar()
        {
            ...
            if ($user_role === false && isset($fed_admin_options['hide_admin_menu_bar']['role']) && array_key_exists('fed_disable_all_user',
                            $fed_admin_options['hide_admin_menu_bar']['role'])) {
                show_admin_bar(false);
            }
        }
        ...
        public function fedt_plugin_versions($version)
        {
            return array_merge($version, array(
                    'dashboard_template' => __('Template ('.FED_TEMPLATES_PLUGIN_VERSION.')',
                            'frontend-dashboard-templates'),
            ));
        }
        ...
        public function fedt_widgets_init()
        {
            register_sidebar(array(
                    ...
                    'description'   => __('The Frontend Dashboard Right Sidebar on Custom Template',
                            'frontend-dashboard-templates'),
