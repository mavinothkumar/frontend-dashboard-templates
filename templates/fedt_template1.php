            ...
            <div class="row fed_dashboard_wrapper">
                <div class="col-md-2 fed_dashboard_menus fed_template1">
                    <div class="custom-collapse fed_menu_items">
                        <button class="bg_secondary collapse-toggle visible-xs visible-sm  <?php echo $is_mobile['d']; ?>" type="button"
                        ...
                        <div class="list-group fed_menu_ul collapse <?php echo $is_mobile['in']; ?>"" id="fed_template1_template" >
